...
BACIO_FFLAGS  = $(OMPFLAGS) -g -O3 -fbacktrace -fPIC
BACIO_CFLAGS  = $(OMPFLAGS) -g -O3 -DUNDERSCORE -DLINUX -fPIC
...
IP_FFLAGS     = $(OMPFLAGS) -g -O3 -fdefault-real-8 -fPIC
IP_ARFLAGS    = -ruv

# Flags for landsfcutil library
LAND_FFLAGS   = $(OMPFLAGS) -g -O3 -I$(MOD_DIR) -fdefault-real-8 -ffree-form -fPIC
LAND_ARFLAGS  = -rv
...
SP_FFLAGS  = $(OMPFLAGS) -g -O3 -fdefault-real-8 -fconvert=big-endian -cpp -DLINUX -fPIC
SP_ARFLAGS = -ruv
...
W3NCO_CFLAGS  = $(OMPFLAGS) -O0 -g -DLINUX -fPIC
W3NCO_ARFLAGS = -ruv
